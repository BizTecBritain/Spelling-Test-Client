...
class TooManyRequestsPage(Base):
    def __init__(self, page_manager) -> None:
        ...
        self.verify_label = Label(self, text='Too many requests have been sent, the server is busy.\nPlease try again '
                                             'later.', font=('Courier', str(int(24*self.ratio))), bg='#E4D6B6')
