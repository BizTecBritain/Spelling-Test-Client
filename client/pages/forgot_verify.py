...
class ForgotVerifyPage(Base):
    def __init__(self, page_manager) -> None:
        ...
        :return: void
        """
        super().__init__("Verify Password Change", 1920, 1080, page_manager)
        ...
        self.verify_label = Label(self, text='Please check your emails to change your password, \n '
                                             'check your inbox and junk folder.', bg='#E4D6B6',
                                  font=('Courier', str(int(24*self.ratio))))
        self.verify_label.place(x=self.ratio * 300, y=self.ratio * 400)  # places the label
